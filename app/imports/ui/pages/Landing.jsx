      ...
      <div className='digits-landing-background'>
        <Grid container stackable centered columns={3}>
          ...
          <Grid.Column textAlign='center'>
            <Icon inverted color='grey' name='users' size='huge'/>
          ...
          <Grid.Column textAlign='center'>
            <Icon inverted color='grey' name='file alternate' size='huge'/>
          ...
          <Grid.Column textAlign='center'>
            <Icon inverted color='grey' name='calendar check outline' size='huge'/>
